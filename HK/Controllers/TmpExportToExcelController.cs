...
namespace HK.Controllers
{
    public class TmpExportToExcelController : BaseController
    {
        ...
        public void ExportContainer()
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=\"Export Container.xlsx\"");
        ...
        public void BuyerNamePackingList()
        {
            ...
            Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
            Response.AddHeader("content-disposition", "attachment;filename=\"Buyer Packing List.xlsx\"");
        ...
        public void CustomsNamePackingList()
        {
            ...
            Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
            Response.AddHeader("content-disposition", "attachment;filename=\"Customs Packing List.xlsx\"");
        ...
        public void CustomsNameInvoice()
        {
            ...
            var containerItems = db.TmpContainerItems
                                    .Where(a => a.ContainerID == CurrentContainerID)
                                    .GroupBy(a => new { a.ProductCustomsName, a.ProductUnit, a.CustomsUnitPrice })
                                    .Select(group => new
                                    {
                                        ProductCustomsName = group.Key.ProductCustomsName,
                                        Quantity = group.Sum(b => b.Quantity),
                                        Rate = group.Key.CustomsUnitPrice,
                                        Price = group.Sum(b => b.Quantity) * group.Key.CustomsUnitPrice
                                    });
            ...
            Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
            Response.AddHeader("content-disposition", "attachment;filename=\"Customs Invoice.xlsx\"");
