...
namespace HK.Controllers
{
    public class BuyersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BuyerID,BuyerCode,BuyerName")] Buyer buyer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BuyerID,BuyerCode,BuyerName")] Buyer buyer)
        {
            if (ModelState.IsValid)
            {
